...
- **TypeScript**: [examples/plugins/hello-world-wasm-typescript](https://github.com/capsohq/bifrost/tree/main/examples/plugins/hello-world-wasm-typescript)
- **Go (TinyGo)**: [examples/plugins/hello-world-wasm-go](https://github.com/capsohq/bifrost/tree/main/examples/plugins/hello-world-wasm-go)
- **Rust**: [examples/plugins/hello-world-wasm-rust](https://github.com/capsohq/bifrost/tree/main/examples/plugins/hello-world-wasm-rust)
