...
**Response**: [`BifrostVideoGenerationResponse`](https://github.com/capsohq/bifrost/blob/main/core/schemas/videos.go) - `id`, `status`, `model`, `videos[]`
...
- [Bifrost Replicate Provider Source](https://github.com/capsohq/bifrost/tree/main/core/providers/replicate)
