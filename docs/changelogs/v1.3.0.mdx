...
- [#605: [Bug]: UI Docker building errors](https://github.com/capsohq/bifrost/issues/605)
- [#597: [Bug Report] Bedrock streaming has many missing chunks](https://github.com/capsohq/bifrost/issues/597)
- [#567: Handling reasoning content](https://github.com/capsohq/bifrost/issues/567)
- [#565: The "pricing not found for model ..." message is repeated for each request processed, which is too noisy for the warn level.](https://github.com/capsohq/bifrost/issues/565)
- [#552: [Bug]: "index" not specified for tool calls in OpenAI chunks](https://github.com/capsohq/bifrost/issues/552)
- [#543: [Bug]: Indicate timeouts in error response while logging](https://github.com/capsohq/bifrost/issues/543)
- [#542: [Feature]: Logs should show timestamps in browser timezone](https://github.com/capsohq/bifrost/issues/542)
- [#520: [Bug]: tokens and cost for "Chat Stream" requests is missing in logs](https://github.com/capsohq/bifrost/issues/520)
- [#516: [Bug]: Can't delete custom provider from Web UI](https://github.com/capsohq/bifrost/issues/516)
- [#504: [Bug]: cannot use self-hosted SGLang instance with http:// URLs only](https://github.com/capsohq/bifrost/issues/504)
- [#497: [Feature]: Add full support for standard OpenTelemetry GenAI Observability](https://github.com/capsohq/bifrost/issues/497)
- [#479: [Feature]: Support for API Key Authentication in Bedrock](https://github.com/capsohq/bifrost/issues/479)
- [#463: [Feature]: Support for Thinking blocks](https://github.com/capsohq/bifrost/issues/463)
- [#456: [Docs]: Update API reference docs](https://github.com/capsohq/bifrost/issues/456)
- [#451: [Feature]: Offline usage](https://github.com/capsohq/bifrost/issues/451)
