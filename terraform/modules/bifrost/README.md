...
Single entry point for deploying [Bifrost](https://github.com/capsohq/bifrost) on AWS, GCP, or Azure. This module handles configuration merging, image resolution, and routes to the appropriate cloud-provider sub-module based on your `cloud_provider` and `service` selections.

## Usage

```hcl
module "bifrost" {
  source = "github.com/capsohq/bifrost//terraform/modules/bifrost"
