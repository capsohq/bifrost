...
test.describe('Network Configuration', () => {
  ...
  test('should display network config tab', async ({ providersPage }) => {
    ...
    await expect(providersPage.page.getByTestId('network-config-timeout-input')).toBeVisible()
  ...
  test('should update timeout value', async ({ providersPage }) => {
    ...
    const timeoutInput = providersPage.page.getByTestId('network-config-timeout-input')
