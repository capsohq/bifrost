...
- [docker-compose.yml](https://github.com/capsohq/bifrost/blob/main/examples/configs/withnginxreverseproxy/docker-compose.yml)
- [helm-values.yaml](https://github.com/capsohq/bifrost/blob/main/examples/configs/withnginxreverseproxy/helm-values.yaml)
- [k8s-ingress.yaml](https://github.com/capsohq/bifrost/blob/main/examples/configs/withnginxreverseproxy/k8s-ingress.yaml)
