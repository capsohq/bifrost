...
const docSections = [
	{
		...
		icon: Play,
		url: "https://github.com/capsohq/bifrost/tree/main/docs/quickstart",
		badge: "Popular",
	...
	},
	{
		...
		icon: GitBranch,
		url: "https://github.com/capsohq/bifrost/tree/main/docs/architecture",
	...
	},
	{
		...
		icon: BookOpen,
		url: "https://github.com/capsohq/bifrost/tree/main/docs/usage",
		badge: "Comprehensive",
	...
	},
	{
		...
		icon: Users,
		url: "https://github.com/capsohq/bifrost/tree/main/docs/contributing",
	...
	},
	{
		...
		icon: Code,
		url: "https://github.com/capsohq/bifrost/tree/main/docs/usage/http-transport/integrations",
	...
	},
	{
		...
		icon: Zap,
		url: "https://github.com/capsohq/bifrost/blob/main/docs/benchmarks.md",
...
const featuredDocs = [
	{
		...
		href: "https://github.com/capsohq/bifrost/blob/main/docs/mcp.md",
		icon: FileText,
	...
	},
	{
		...
		href: "https://github.com/capsohq/bifrost/blob/main/docs/governance.md",
		icon: Shield,
				...
				<div className="space-y-8">
					...
					<div className="space-y-4 text-center">
						...
						<div className="flex justify-center gap-4">
							<Button asChild>
								<a href="https://github.com/capsohq/bifrost/tree/main/docs" target="_blank" rel="noreferrer">
									<ExternalLink className="mr-2 h-4 w-4" />
									View Full Documentation
								</a>
							</Button>
							<Button variant="outline" asChild>
								<a href="https://github.com/capsohq/bifrost/tree/main/docs/quickstart" target="_blank" rel="noreferrer">
								...
								<Card key={section.title} className="group transition-all duration-200 hover:shadow-lg">
									...
									<CardContent className="flex h-full flex-col justify-between gap-8">
										...
										<Button asChild variant="outline" className="w-full">
											<a href={section.url} target="_blank" rel="noreferrer" className="flex items-center justify-center gap-2">
												Read More
