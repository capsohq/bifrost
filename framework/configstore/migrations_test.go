...
func setupKeyDBWithLegacyDeploymentColumns(t *testing.T) *gorm.DB {
	...
	err = db.Exec(`
		CREATE TABLE config_keys (
			...
			bedrock_mantle_access_key TEXT,
			bedrock_mantle_secret_key TEXT,
			bedrock_mantle_session_token TEXT,
			bedrock_mantle_region TEXT,
			bedrock_mantle_role_arn TEXT,
			bedrock_mantle_external_id TEXT,
			bedrock_mantle_role_session_name TEXT,
