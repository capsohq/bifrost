...
<video width="100%" controls>
  <source
    src="https://github.com/capsohq/bifrost/raw/refs/heads/main/docs/media/run-npx.mp4"
    type="video/mp4"
  />
...
<Warning>
These unversioned commands are for local evaluation. For a hosted or production deployment, pin an image version, enable authentication and TLS, and choose durable storage using the [deployment support matrix](/deployment-guides/overview).
</Warning>
